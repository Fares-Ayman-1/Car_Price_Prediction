...
![Linear Regression Train Actual vs Predicted](Images/Linear_train_data_Actual_Price_vs_Predicted_Price.png)
...
![Linear Regression Train Residuals](Images/Linear_train_data_Residual_Plot.png)
...
![Linear Regression Test Actual vs Predicted](Images/Linear_test_data_Actual_Price_vs_Predicted_Price.png)
...
![Linear Regression All Data Actual vs Predicted](Images/Linear_all_data_Actual_Price_vs_Predicted_Price.png)
...
```text
Images/Linear_model_Actual_Price_vs_Predicted_Price.png
```

![Model](Images/Linear_model_Actual_Price_vs_Predicted_Price.png)
...
```bash
git clone https://github.com/Fares-Ayman-1/Car_Price_Prediction.git
```
